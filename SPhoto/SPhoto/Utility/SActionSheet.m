...
otherSheetItemTypes:(SheetButtonType) aSheetItemType, ... {
    ...
    if(self) {
        ...
        self.actionSheetHeight = kSheetTopHeight + self.numberOfSheetButtons * (kSheetButtonHeight+kSheetButtonSepartorHeight);
        ...
        self.topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kSheetButtonWidth, kSheetTopHeight)];
        ...
        self.titleView = [[UIView alloc] initWithFrame:CGRectMake(0, kSheetTopShadowHeight, 320, kSheetTopHeight - kSheetTopShadowHeight)];
...
- (SheetItemView *) createCancelButton {
    ...
    [itemView setSheetButtonType:RVSheetButtonCancel];
