...
- (BOOL) _parseConfiguration:(NSDictionary *)configuration {
    ...
    for (NSDictionary *filter in filters) {
        ...
        SFilter *genericFilter = [[theClass alloc] init];
...
- (UIImage *) currentFilteredFrame {
    return [(SFilter*)[_filters lastObject] imageFromCurrentlyProcessedOutput];
}

- (CGImageRef) newCGImageFromCurrentFilteredFrame {
    return [(SFilter*)[_filters lastObject] newCGImageFromCurrentlyProcessedOutput];
}
