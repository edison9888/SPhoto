...
- (void) show {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:SCameraViewWillAppear object:self.window];
...
- (void) hide {
    ...
    self.transition.type = @"cameraIris";
    [self.window.layer addAnimation:self.transition forKey:nil];
    [[NSNotificationCenter defaultCenter] postNotificationName:SCameraViewWillDisappear object:nil];
...
NSString * const SCameraViewWillAppear = @"kCameraViewWillAppear";
NSString * const SCameraViewWillDisappear = @"kCameraViewWillDisappear";
