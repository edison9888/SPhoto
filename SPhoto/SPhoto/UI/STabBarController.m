...
- (id) init {
    ...
    if (self) {
        ...
        SNavigationController * navigationBar1, * navigationBar2, * navigationBar3, * navigationBar4, * navigationBar5;
        
        UIImage * image = [UIImage imageNamed:@"photo1.jpg"];
        
        viewController1 = [[SImageViewController alloc] initWithImage:image];
        ...
        viewController3 = [[SCaremaViewController alloc] init];
        navigationBar3 = [[SNavigationController alloc] initWithRootViewController:viewController3];
        navigationBar3.delegate = self;
        ...
        self.viewControllers = [NSArray arrayWithObjects:navigationBar1, navigationBar2, navigationBar3, navigationBar4, navigationBar5, nil];
