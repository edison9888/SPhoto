#import "SSphereRefractionFilter.h"
...
@interface SSphereRefractionFilter ()
...
@implementation SSphereRefractionFilter
...
- (void)setRadius:(CGFloat)newValue;
{
    ...
    [super setFloat:_radius forUniform:radiusUniform program:filterProgram];
}
